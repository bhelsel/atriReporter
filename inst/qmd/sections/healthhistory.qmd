...
#| echo: false
#| eval: !expr (params$healthhistory) | (params$healthhistory_by_sex)
#| results: asis
...
if (params$healthhistory_by_sex) {
  demographics <- atriReporter::get_demographics(de_gender, apply_labels = TRUE)
  ids <- atriReporter:::get_ids(demographics)
  healthhistory <- atriReporter::atri_join(
    demographics,
    healthhistory,
    by = ids,
...
create_chd_table <- function(data, filter_by = NULL) {
  filter_by <- rlang::enquo(filter_by)

  if (!rlang::quo_is_null(filter_by)) {
    data <- dplyr::filter(data, {{ filter_by }})
  }
...
create_chd_table(healthhistory)

```

```{r congenital heart disease males}
#| echo: false
#| eval: !expr params$healthhistory_by_sex
#| results: asis

atriReporter:::format_quarto(
  "Congenital Heart Disease by Males",
  type = "subsubsection"
)

create_chd_table(healthhistory, de_gender == "Male")

```

```{r congenital heart disease females}
#| echo: false
#| eval: !expr params$healthhistory_by_sex
#| results: asis

atriReporter:::format_quarto(
  "Congenital Heart Disease by Females",
  type = "subsubsection"
)

create_chd_table(healthhistory, de_gender == "Female")
...
create_health_conditions_table <- function(data, filter_by = NULL) {
  filter_by <- rlang::enquo(filter_by)
  ...
  type1 <- sum(data$hh_diabetes_type == "Type 1", na.rm = TRUE)
  type2 <- sum(data$hh_diabetes_type == "Type 2", na.rm = TRUE)
  # fmt: skip
  diabetes_type <- paste0("Type 1 Diabetes (N = ", type1, "); Type 2 Diabetes (N = ", type2, ")")
...
create_health_conditions_table(healthhistory)

```

```{r health conditions males}
#| echo: false
#| eval: !expr params$healthhistory_by_sex
#| results: asis

atriReporter:::format_quarto(
  "Health Conditions by Males",
  type = "subsubsection"
)

create_health_conditions_table(healthhistory, de_gender == "Male")

```

```{r health conditions females}
#| echo: false
#| eval: !expr params$healthhistory_by_sex
#| results: asis

atriReporter:::format_quarto(
  "Health Conditions by Females",
  type = "subsubsection"
)

create_health_conditions_table(healthhistory, de_gender == "Female")
...
```{r get anthropometrics by cycle}
#| echo: false
#| eval: !expr (params$healthhistory) | (params$healthhistory_by_sex)
#| results: asis
...
if (params$healthhistory_by_sex) {
  demographics <- atriReporter::get_demographics(de_gender, apply_labels = TRUE)
  ids <- atriReporter:::get_ids(demographics)
  exam <- atriReporter::atri_join(
    demographics,
    exam,
    by = ids,
    join_type = right_join
  )
  exam <- tidyr::fill(exam, de_gender, .by = subject_label, .direction = "down")
}
...
create_bmi_table <- function(data, filter_by = NULL) {
  filter_by <- rlang::enquo(filter_by)
...
create_bmi_table(bmi)

```

```{r anthropometrics males}
#| echo: false
#| eval: !expr params$healthhistory_by_sex
#| results: asis

atriReporter:::format_quarto(
  "Anthropometrics by Males",
  type = "subsubsection"
)

create_bmi_table(bmi, de_gender == "Male")

```

```{r anthropometrics females}
#| echo: false
#| eval: !expr params$healthhistory_by_sex
#| results: asis

atriReporter:::format_quarto(
  "Anthropometrics by Females",
  type = "subsubsection"
)

create_bmi_table(bmi, de_gender == "Female")
